	...
	<body>
		<div id="o1">
			...
			<div id="x1">
				<ul>
					<li>
						<img src="img/perfume/21.jpg" height="220" width="220">
                                                            凯卓KENZO纯净之水香水<p class="my_price">￥169.00</p>
					</li>
				</ul>
			</div>
			<div id="y1">
				<ul>
					<li>
						<img src="img/perfume/41.jpg" height="220" width="220">
						男士ck香水100ml<p class="my_price">￥179.00</p>
					</li>
				</ul>
			</div>
			...
			<div id="a7">
				<div id="mybottom_top">
				<div id="top_in01">
					<p class="Big_logo">爱尚网购</br>loveing shopping</p>
					</br><p class="ban_title">营业执照注册号：330106000129004</p>
					</br>
