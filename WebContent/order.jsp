	...
	<div class="bottom-links">
		<ul class="clearfix cols">
			...
			<li class="col">
				...
				<ul class="clearfix bottom-links-items">
					<li><img src="images/weixin_big.jpg" /></li>
				</ul>
			</li>
			<li class="col">
				...
				<ul class="clearfix bottom-links-items">
					...
					<li><img src="images/icon_tencent.png" /> <a href="#">腾讯微博</a>
					</li>
					<li><img src="images/icon_dou.png" /> <a href="#">豆瓣小站</a></li>
					<li><img src="images/icon_weixin.png" /> <a href="#">官方微信</a>
					</li>
				</ul>
			</li>
		...
		<div class="w">
			<p class="foot_p1">
				<a href="#">首页</a>| <a href="#">招聘英才</a>| <a href="#">广告合作</a>| <a
					href="#">联系我们</a>| <a href="#">关于我们</a>
			</p>
			<pre>
    经营许可证：苏B2-20130223备案许可证：苏ICP备13041162号-1360网站安全检测平台
    ©2013-2014 无锡太湖云电商网络科技发展有限公司   版权所有  更多模板：<a
					href="http://www.mycodes.net/" target="_blank">源码之家</a>
                </pre>
		</div>
		<p>
			<a href="#"><img src="images/bottom_img01.png"></a> <a href="#"><img
				src="images/bottom_img02.png"></a> <a href="#"><img
				src="images/bottom_img03.png"></a> <a href="#"><img
				src="images/bottom_img04.png"></a> <a href="#"><img
				src="images/bottom_img05.png"></a> <a href="#"><img
				src="images/bottom_img06.png"></a> <a href="#"><img
				src="images/bottom_img07.png"></a> <a href="#"><img
				src="images/bottom_img08.png"></a> <a href="#"><img
				src="images/bottom_img09.png"></a>
		</p>
	</div>
	<!-- 底部 -->
	<div class="fixed-buttons">
		<ul>
			<li><a href="#" class="fixed-weixin"><img
					src="images/fixed_weixin.png" />
