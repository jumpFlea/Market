...
<div class="page-num">
			...
			<ul class="pagination">
				<c:if test="${goodsorder.currentPage!=1}">
					<li><a href="comletedOrderIndex?page=${goodsorder.currentPage-1}&type=${type}"><span aria-hidden="true">&laquo;</span></a></li>
				</c:if>
				...
				<c:if test="${goodsorder.currentPage!=goodsorder.countPage}">
					<li><a href="comletedOrderIndex?page=${goodsorder.currentPage+1}&type=${type}"><span>&raquo;</span></a></li>
				</c:if>
			</ul>
			</nav>
		</div>
